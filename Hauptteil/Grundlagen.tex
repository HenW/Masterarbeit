...
\subsection{Übersicht der getesteten Konfiguration}\label{kap:getestetekonfiguration}
...
\subsection{Ergebnisse der Dhrystone-Benchmark}\label{kap:dhrystonetest}
